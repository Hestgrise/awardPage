...
app.router.add(webapp2.Route(r'/adminEditAdminAccount.html', 'api.AdminEditAdminPage'))
...
app.router.add(webapp2.Route(r'/fillAdminEditAdminPage', 'api.FillAdminEditAdminPage'))
app.router.add(webapp2.Route(r'/doAdminEditUser', 'api.DoAdminEditUser'))
app.router.add(webapp2.Route(r'/doAdminEditAdmin', 'api.DoAdminEditAdmin'))
app.router.add(webapp2.Route(r'/admins.html', 'api.AdminsPage'))
app.router.add(webapp2.Route(r'/createAdminAccount', 'api.CreateAdminAccount'))
